    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //ImGui
        {
...

            {
                ...
                ImGui::Button("Pass");
                ImGui::Button("Call");
                ImGui::RadioButton("Purple Cards", &blankCard, 4); ImGui::SameLine();
                ImGui::RadioButton("Orange Cards", &blankCard, 3); ImGui::SameLine();
                ImGui::RadioButton("Green Cards", &blankCard, 2); ImGui::SameLine();
                ImGui::RadioButton("Blue Cards", &blankCard, 1);
